...
<img class="alignnone size-full wp-image-232" title="plotrows-dataview" src="http://blog.xiaoq.in/cdn/images/2011/03/plotrows-dataview.png" alt="" width="356" height="230" />
...
<div style="width: 640px; max-width: 100%;" class="wp-video">
  <!--[if lt IE 9]><![endif]--><video class="wp-video-shortcode" id="video-228-1" width="640" height="360" preload="metadata" controls="controls"><source type="video/mp4" src="http://blog.xiaoq.in/cdn/images/2011/03/plot.mp4?_=1" />
  
  <a href="http://blog.xiaoq.in/cdn/images/2011/03/plot.mp4">http://blog.xiaoq.in/cdn/images/2011/03/plot.mp4</a></video>
</div>
...
当查看如访问等的持续性<span class='wp_keywordlink_affiliate'><a href="http://blog.xiaoq.in/tag/%e7%bb%b4%e5%ba%a6/" title="查看维度中的全部文章" target="_blank">维度</a></span>时，绘制选定行在探究具有相似规模的行之时会效果会最明显，比如查看他们是如何对整体做出贡献以及在一段时间内的变化情况。当查看不同规模行的时候，这样的图表会比使用如蹦失率这样的百分比<span class='wp_keywordlink_affiliate'><a href="http://blog.xiaoq.in/tag/%e7%bb%b4%e5%ba%a6/" title="查看维度中的全部文章" target="_blank">维度</a></span>更具有可读性。
...
在这个例子中，我们来看下Google Store 来自Google和Bing的搜索引擎自然流量。我们可能不会想到Bing的使用者会积极地想买Google的商品（比如这个漂亮的T恤），因此访问者较少是可以理解的。由于来自Bing的流量相对较低，这个图表与我们未曾从表格中获知的数据并未有较多共同点。

<img class="alignnone size-full wp-image-234" title="plotrows-store-visits" src="http://blog.xiaoq.in/cdn/images/2011/03/plotrows-store-visits.png" alt="" width="806" height="343" />
...
在<span class='wp_keywordlink_affiliate'><a href="http://blog.xiaoq.in/tag/%e6%96%b0%e7%89%88%e8%b0%b7%e6%ad%8c%e5%88%86%e6%9e%90/" title="查看新版谷歌分析中的全部文章" target="_blank">新版谷歌分析</a></span>中，你可以通过点击平衡记分卡中的任意维度来绘制图表。查看蹦失率，我们可以看到在这个时间段，来自<span class='wp_keywordlink_affiliate'><a href="http://blog.xiaoq.in/tag/%e8%b0%b7%e6%ad%8c/" title="查看谷歌中的全部文章" target="_blank">谷歌</a></span>搜索引擎（橙色线条）的蹦失率下降了，这在整体上也降低了整站（蓝色线条）的蹦失率，来自Bing（绿色线条）的蹦失率基本保持不变。

<img class="alignnone size-full wp-image-235" title="plotrows-store-bounce" src="http://blog.xiaoq.in/cdn/images/2011/03/plotrows-store-bounce.png" alt="" width="807" height="322" />
...
你可以在含有数据表格的几乎任何报告中使用绘制选定行。如果你发现一个想使用的地方没有该功能，请让我们知道。同时，我们将在这周给共多用户开放新版。敬请关注！

Posted by Trevor Claiborne, Google Analytics Team

<span class='wp_keywordlink_affiliate'><a href="http://blog.xiaoq.in/tag/%e8%b0%b7%e6%ad%8c/" title="查看谷歌中的全部文章" target="_blank">谷歌</a></span>分析小组，Trevor Claiborne发表