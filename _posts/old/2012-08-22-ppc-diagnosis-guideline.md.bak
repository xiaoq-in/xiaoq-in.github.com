...
tags:
  - ppc账户诊断
---
以最有限的时间进行最大的效果提升，这是每个大型账户管理人员必须面临的一个挑战，同样，当你接手一个全新账户时，进行快速有效的诊断也是对于<span class='wp_keywordlink'><a href="https://xiaoq.in/sem/" title="SEM搜索引擎营销" target="_blank">SEM</a></span>的一大挑战。

无论你是做<span class='wp_keywordlink'><a href="https://xiaoq.in/google-adwords/" title="谷歌广告" target="_blank">谷歌广告</a></span>也好，百度推广也罢。其实原理都是类似的，具体的执行方式和媒介区别不在本文的阐述范围。
...
在<span class='wp_keywordlink'><a href="https://xiaoq.in/google-adwords/" title="Google Adwords" target="_blank">Google Adwords</a></span>中我们可以先使用广告诊断工具，查看市场份额比例，相对点击率这些，通过这些大致了解广告的目前运行情况和市场竞争状态。而在百度推广中，有一个所谓的SOC可以让百度的人去跑数据，在后台似乎也有一个市场份额数据（准确性有待考量）。百度后台最近的更新中提供了广告优化提示，这个提示对于广告主有比较好的参考性，但是请勿直接应用，毕竟百度不了解你的业务和目标。百度的这个工具有点类似于谷歌的优化工具。
